...
export default function AboutSection() {
  const stats = [
    ...
    { icon: Coffee, value: "1000+", label: "my film" },
    { icon: Rocket, value: "", label: "my self" },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              𝙄 𝙬𝙖𝙨 𝙗𝙤𝙧𝙣 𝙞𝙣 𝘽𝙖𝙣𝙙𝙖 𝘼𝙘𝙚𝙝 𝙤𝙣 𝘿𝙚𝙘𝙚𝙢𝙗𝙚𝙧 27, 2009. 𝙈𝙮 𝙝𝙤𝙗𝙗𝙮 𝙞𝙨 𝙧𝙚𝙖𝙙𝙞𝙣𝙜.               𝙄 𝙖𝙢 𝙖 𝙨𝙩𝙪𝙙𝙚𝙣𝙩 𝙬𝙝𝙤 𝙝𝙖𝙨 𝙖 𝙜𝙧𝙚𝙖𝙩 𝙞𝙣𝙩𝙚𝙧𝙚𝙨𝙩 𝙞𝙣 𝙢𝙖𝙩𝙝𝙚𝙢𝙖𝙩𝙞𝙘𝙨.               𝘾𝙪𝙧𝙧𝙚𝙣𝙩𝙡𝙮, 𝙄 𝙖𝙢 𝙨𝙩𝙪𝙙𝙮𝙞𝙣𝙜 𝙖𝙩 𝙈𝘼𝙉 𝙈𝙤𝙙𝙚𝙡 𝘽𝙖𝙣𝙙𝙖 𝘼𝙘𝙚𝙝.
            </p>

            <p className="text-gray-400 leading-relaxed">
               
              <span className="text-purple-400"> </span>  
              <span className="text-blue-400"> 𝙄𝙛 𝙞 𝙝𝙖𝙙 𝙩𝙤 𝙙𝙚𝙨𝙘𝙧𝙞𝙗𝙚 𝙢𝙮 𝙨𝙚𝙡𝙛 𝙞𝙣 𝙩𝙝𝙧𝙚𝙚𝙚 𝙬𝙤𝙧𝙙𝙨: 𝘾𝙪𝙧𝙞𝙤𝙪𝙨, 𝙘𝙧𝙚𝙖𝙩𝙞𝙫𝙚, 𝙖𝙣𝙙 𝙘𝙤𝙣𝙨𝙩𝙖𝙣𝙡𝙮 𝙡𝙚𝙖𝙧𝙣𝙞𝙣𝙜. 𝙄 𝙗𝙚𝙡𝙞𝙚𝙫𝙚 𝙚𝙫𝙚𝙧𝙮 𝙙𝙖𝙮 𝙞𝙨 𝙖𝙣 𝙤𝙥𝙥𝙤𝙧𝙩𝙪𝙣𝙞𝙩𝙮 𝙩𝙤 𝙗𝙚𝙘𝙤𝙢𝙚 𝙖 𝙗𝙚𝙩𝙩𝙚𝙧 𝙫𝙚𝙧𝙨𝙞𝙤𝙣 𝙤𝙛 𝙤𝙪𝙧𝙨𝙚𝙡𝙫𝙚𝙨. 𝙎𝙤, 𝙞'𝙢 𝙣𝙤𝙩 𝙟𝙪𝙨𝙩 𝙝𝙚𝙧𝙚 𝙩𝙤 𝙞𝙣𝙩𝙧𝙤𝙙𝙪𝙘𝙚 𝙢𝙮𝙨𝙚𝙡𝙛, 𝙗𝙪𝙩 𝙖𝙡𝙨𝙤 𝙩𝙤 𝙜𝙧𝙤𝙬 𝙩𝙤𝙜𝙚𝙩𝙝𝙚𝙧.</span>. 
